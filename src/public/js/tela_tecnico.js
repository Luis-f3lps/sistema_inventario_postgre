...
function renderUI(requests) {
    ...
    // --- RENDERIZAR AULAS INDIVIDUAIS (NOVO VISUAL EM CARDS) ---
    if (individuais.length === 0) {
        ...
        individuais.forEach(r => {
            ...
            // Só desabilita botões se a aula já foi cancelada
            ...
            card.innerHTML = `
                ...
                <div class="aula-card-body">
                    <div class="aula-card-info-linha">
                        ...
                        <p><strong><i class="fas fa-users"></i> Discentes:</strong> ${r.numero_discentes || '-'}</p>
                ...
                <div class="aula-card-footer" style="display: flex; justify-content: space-between; align-items: center; margin-top: 15px; padding-top: 10px; border-top: 1px solid #eee;">
                    ...
                    <div class="acoes-recorrente" style="margin-top: 0; display: flex; gap: 10px;">
                        <button class="botao-de-acao botao-aceitar" data-ids='["${r.id_aula}"]' ${isDesativado ? 'disabled' : ''} style="padding: 8px 15px; background-color: #28a745; color: white; border: none; border-radius: 4px; cursor: pointer; ${estiloBotaoDesativado}">
                            <i class="fas fa-check"></i> Autorizar
                        </button>
                        <button class="botao-de-acao botao-recusar" data-ids='["${r.id_aula}"]' ${isDesativado ? 'disabled' : ''} style="padding: 8px 15px; background-color: #dc3545; color: white; border: none; border-radius: 4px; cursor: pointer; ${estiloBotaoDesativado}">
